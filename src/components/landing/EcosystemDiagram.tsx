...
const EcosystemDiagram = () => (
	...
	>
		<div className="md:hidden rounded-3xl border border-border bg-[radial-gradient(circle_at_50%_40%,hsla(359,74%,52%,0.10)_0%,hsla(220,24%,96%,0.96)_54%,hsla(220,20%,92%,1)_100%)] p-4 sm:p-5">
			<div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-primary/35 bg-card shadow-[0_12px_26px_hsla(359,74%,52%,0.16)]">
				<span className="font-display text-4xl leading-none text-primary">d</span>
			</div>
			<div className="grid gap-3">
				<div className="rounded-2xl border border-border bg-card/95 px-3 py-3 text-center shadow-[0_8px_24px_hsla(224,28%,12%,0.08)]">
					<p className="flex items-center justify-center gap-1.5 text-[10px] tracking-[1.2px] text-foreground/85"><ShoppingBag className="h-3.5 w-3.5 text-primary" />BRAND</p>
					<p className="text-[11px] font-medium text-muted-foreground leading-tight">Inventory &amp; margin</p>
					<p className="mt-0.5 text-[10px] leading-tight text-muted-foreground">Cung cấp hàng hóa chất lượng &amp; chia sẻ doanh thu tự động.</p>
				</div>
				<div className="rounded-2xl border border-border bg-card/95 px-3 py-3 text-center shadow-[0_8px_24px_hsla(224,28%,12%,0.08)]">
					<p className="flex items-center justify-center gap-1.5 text-[10px] tracking-[1.2px] text-foreground/85"><Users className="h-3.5 w-3.5 text-primary" />USER</p>
					<p className="text-[11px] font-medium text-muted-foreground leading-tight">Experience &amp; value</p>
					<p className="mt-0.5 text-[10px] leading-tight text-muted-foreground">Trải nghiệm mua sắm O2O liền mạch với giá gốc Member.</p>
				</div>
				<div className="rounded-2xl border border-border bg-card/95 px-3 py-3 text-center shadow-[0_8px_24px_hsla(224,28%,12%,0.08)]">
					<p className="flex items-center justify-center gap-1.5 text-[10px] tracking-[1.2px] text-foreground/85"><BadgeDollarSign className="h-3.5 w-3.5 text-primary" />CREATORS</p>
					<p className="text-[11px] font-medium text-muted-foreground leading-tight">Content &amp; influence</p>
					<p className="mt-0.5 text-[10px] leading-tight text-muted-foreground">Biến review thành thu nhập qua mạng lưới affiliate thông minh.</p>
				</div>
			</div>
			<div className="mt-4 rounded-full border border-border bg-card/85 px-3 py-1.5 text-center backdrop-blur-sm">
				<p className="text-[10px] tracking-[1.5px] text-muted-foreground uppercase">Social Commerce O2O Loop</p>
			</div>
		</div>

		<div className="relative hidden md:block aspect-[19/10] w-full overflow-visible rounded-[28px] border border-border bg-[radial-gradient(circle_at_50%_40%,hsla(359,74%,52%,0.10)_0%,hsla(220,24%,96%,0.96)_54%,hsla(220,20%,92%,1)_100%)] px-4 py-6 md:px-8 md:py-7">
